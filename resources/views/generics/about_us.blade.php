...
<div class="div-discover-heol">
        <p class="txt-discover-heol">
            ...
            domaine d’activité de l’industrie de la mode, et plus précisément la production de produits sportifs éco-
            responsables et français.
        </p>
        <p class="txt-discover-heol">
            HEOL s’adapte aux tendances de consommation et à nôtre avenir pour la planète, en innovant chaque
            jour pour rendre les moments de consommation des sportifs moins réguliers mais de meilleure qualité
